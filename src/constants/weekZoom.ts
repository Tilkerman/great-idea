...
/**
 * Насколько сильно нужно «продавить» ниже нуля щипком, чтобы уйти с полной недели на месяц.
 * 0.2 ≈ прежний лёгкий жест; держим заметно выше, чтобы всю неделю было легко поймать.
 */
export const WEEK_TO_MONTH_OVERSHOOT = 0.48;
